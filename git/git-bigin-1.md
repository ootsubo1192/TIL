...
reset -> 間違えたコミットをコミットポイントごと消す

revert -> 間違えたコミットを新たにコミットポイントを作成して、削除したように見せる

履歴が残るので基本的にrevertコマンドを使用

間違えてパスワードをコミットしてしまった時に、resetコマンドを使用する

`$ git revert HEAD` -> 最新のコミットをrevertする
